...
weewx.units.obs_group_dict['rxFrequencyError'] = 'group_frequency'
...
weewx.units.obs_group_dict['waveMeanHeightHighestTenth'] = 'group_altitude'
weewx.units.obs_group_dict['waveSignificantHeight'] = 'group_altitude'
weewx.units.obs_group_dict['waveMaximumHeight'] = 'group_altitude'
