#
#    Based on https://github.com/weewx/weewx/blob/v5.1.0/src/schemas/wview_extended.py
#
#    Portions Copyright (c) 2009-2020 Tom Keffer <tkeffer@gmail.com>
#
...
table = [('dateTime',             'INTEGER NOT NULL UNIQUE PRIMARY KEY'),
         ...
         ('waveMeanHeight',       'REAL'),
         ('waveMeanHeightHighestTenth', 'REAL'),
         ('waveSignificantHeight','REAL'),
         ('waveMaximumHeight',    'REAL'),
         ]
